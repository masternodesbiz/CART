...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* cart features */
        {"cart", "listmasternodes", &listmasternodes, true, true, false},
        {"cart", "getmasternodecount", &getmasternodecount, true, true, false},
        {"cart", "masternodeconnect", &masternodeconnect, true, true, false},
        {"cart", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"cart", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"cart", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"cart", "masternodecurrent", &masternodecurrent, true, true, false},
        {"cart", "masternodedebug", &masternodedebug, true, true, false},
        {"cart", "startmasternode", &startmasternode, true, true, false},
        {"cart", "createmasternodekey", &createmasternodekey, true, true, false},
        {"cart", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"cart", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"cart", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"cart", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"cart", "getmasternodescores", &getmasternodescores, true, true, false},
        {"cart", "preparebudget", &preparebudget, true, true, false},
        {"cart", "submitbudget", &submitbudget, true, true, false},
        {"cart", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"cart", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"cart", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"cart", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"cart", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"cart", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"cart", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"cart", "checkbudgets", &checkbudgets, true, true, false},
        {"cart", "mnsync", &mnsync, true, true, false},
        {"cart", "spork", &spork, true, true, false},
        {"cart", "getpoolinfo", &getpoolinfo, true, true, false},
        {"cart", "getcollateral", &getcollateral, true},
...
{
    return "> cart-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:5729/\n";
}
